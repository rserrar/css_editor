...
export function StartScreen({ onNew, onLoad, draftSummary, onRestoreDraft, onDiscardDraft, startError }: Props) {
  ...
  return (
    <div className="min-h-screen bg-bg-base flex flex-col items-center justify-center p-6 text-[13px]">
        ...
        {draftSummary && (
          <div className="bg-white border border-amber-200 rounded-xl shadow-sm p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="text-[11px] font-bold uppercase tracking-widest text-amber-700 mb-2">{t('start.draftAvailable')}</div>
                ...
                <p className="text-[12px] text-text-muted mt-3">{t('start.draftDescription')}</p>
          ...
          <form onSubmit={(e) => {
            ...
            <div className="relative mb-4">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2 bg-white border border-border rounded-md focus:outline-none focus:ring-4 focus:ring-accent/10 focus:border-accent transition-all font-medium text-[13px]"
              />
            </div>
